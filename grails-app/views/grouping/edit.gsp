...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'grouping.label', default: 'Grouping')}" />
...
<div id="content" role="main">
    <div class="container">
        <section class="row">
            <a href="#edit-grouping" class="visually-hidden-focusable" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <section class="row">
            <div id="edit-grouping" class="col-12 content scaffold-edit" role="main">
                <h1><g:message code="default.edit.label" args="[entityName]" /></h1>
                <g:flashMessages />
                <g:hasErrors bean="${this.grouping}">
                    <ul class="alert alert-danger list-unstyled" role="alert">
                        <g:eachError bean="${this.grouping}" var="error">
                ...
                <g:form resource="${this.grouping}" controller="${controllerName}" method="PUT">
                    <g:hiddenField name="version" value="${this.grouping?.version}" />
                    <fieldset class="form">
                        <f:all bean="grouping" class="row" requiredClass="mb-3 required" labelClass="col-sm-2 col-form-label text-sm-end" divClass="col-sm-10" widget-class="form-control" widget-invalidClass="is-invalid" widget-selectDateClass="w-auto form-select d-inline" widget-checkBoxClass="form-check-input align-middle" />
                    </fieldset>
