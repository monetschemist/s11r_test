...
<div id="content" role="main">
    <div class="container">
        <section class="row">
            <a href="#show-grouping" class="visually-hidden-focusable" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <section class="row">
            <div id="show-grouping" class="col-12 content scaffold-show" role="main">
                <h1><g:message code="default.show.label" args="[entityName]" /></h1>
                <g:flashMessages />
                <f:display bean="grouping" listClass="container" listItemClass="row mb-3" labelClass="form-label col-sm-3 text-sm-end" valueClass="col-sm-9" />
                <g:form resource="${this.grouping}" controller="${controllerName}" method="DELETE">
                    <fieldset class="bg-body-tertiary">
                        <g:link class="btn btn-outline-primary" action="edit" resource="${this.grouping}" controller="${controllerName}">
