...
<div id="content" role="main">
    <div class="container">
        <section class="row">
            <a href="#edit-person" class="visually-hidden-focusable" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <section class="row">
            <div id="edit-person" class="col-12 content scaffold-edit" role="main">
                ...
                <g:form resource="${this.person}" controller="${controllerName}" method="PUT">
